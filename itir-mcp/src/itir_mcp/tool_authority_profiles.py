...
REGISTRY_TOOL_AUTHORITY_PROFILE_SPECS: tuple[ToolAuthorityProfile, ...] = (
    ...
    ToolAuthorityProfile(
        ...
        promotion_requires_gate=False,
        authority_notes={
            "authority_class": "domain_migration_candidate",
            "candidate_only": True,
            "non_authoritative": True,
            "note": "Wikidata migration candidates summarize structural refs and hints without mutation or truth promotion.",
        },
    ),
    ToolAuthorityProfile(
        tool_id="itir.climate.claim_review",
        kind=ToolKind.REPORTING.value,
        inputs=(AuthorityStatus.OBSERVED.value, AuthorityStatus.CANDIDATE.value, AuthorityStatus.RECEIPT.value),
        outputs=(AuthorityStatus.RECEIPT.value,),
        mutates=False,
        ...
        promotion_requires_gate=False,
        authority_notes={
            "authority_class": "domain_claim_review",
            "candidate_only": True,
            "non_authoritative": True,
            "note": "Climate claim review packets expose candidate support and contradiction counts only.",
        },
    ),
    ToolAuthorityProfile(
        tool_id="itir.gwb.follow_graph",
        kind=ToolKind.CANDIDATE_CLOSURE.value,
        inputs=(AuthorityStatus.OBSERVED.value, AuthorityStatus.CANDIDATE.value, AuthorityStatus.RECEIPT.value),
        outputs=(AuthorityStatus.RECEIPT.value,),
        mutates=False,
        ...
        promotion_requires_gate=False,
        authority_notes={
            "authority_class": "domain_follow_graph",
            "candidate_only": True,
            "non_authoritative": True,
            "note": "GWB/Brexit follow graphs expose candidate external-authority relations without promotion.",
        },
    ),
    ToolAuthorityProfile(
    ...
    ToolAuthorityProfile(
        tool_id="itir.zelph.pack_sources",
        kind=ToolKind.ARTIFACT_TRANSPORT.value,
        inputs=(AuthorityStatus.OBSERVED.value, AuthorityStatus.RECEIPT.value),
        outputs=(AuthorityStatus.RECEIPT.value,),
        mutates=False,
        ...
        promotion_requires_gate=False,
        authority_notes={
            "authority_class": "pack_source_descriptor",
            "candidate_only": True,
            "non_authoritative": True,
            "note": "Zelph pack source descriptors validate local records and surface URLs as reference-only metadata.",
        },
    ),
    ToolAuthorityProfile(
        tool_id="itir.spectral.candidate_packet",
        kind=ToolKind.CANDIDATE_CLOSURE.value,
        inputs=(AuthorityStatus.OBSERVED.value, AuthorityStatus.CANDIDATE.value, AuthorityStatus.RECEIPT.value),
        outputs=(AuthorityStatus.RECEIPT.value,),
        mutates=False,
        ...
        promotion_requires_gate=False,
        authority_notes={
            "authority_class": "spectral_candidate_packet",
            "candidate_only": True,
            "non_authoritative": True,
            "note": "Spectral candidate packets remain non-authoritative projections of partial and spectral inputs.",
        },
    ),
    ToolAuthorityProfile(
